...
# Function for google search using SerpApi
...
researcher = GPTAssistantAgent(
    ...
    llm_config = {
        ...
        "assistant_id": "asst_97g6OCTI5399ENcKGauMHy4D"
    }
)
...
research_manager = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_YrTTjdyHvLsRLLAfcjttJrtl"
    }
)
...
director = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_FCgrstccusUCVgZlaH6Rm7Uj",
    }
)
